...
namespace SpriteKind {
    ...
    export const bossmovementtype = SpriteKind.create()
    export const bossmovementtypeworld2 = SpriteKind.create()
    export const enemy_world3 = SpriteKind.create()
    export const enemy_world3_left = SpriteKind.create()
    export const enemy_world3_right = SpriteKind.create()
    export const world2_coin = SpriteKind.create()
    export const world3_coin = SpriteKind.create()
    export const bossmovementtype3 = SpriteKind.create()
}
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleBlueCrystal, function (sprite3, location) {
    flying_enemy_timer = 0
    if (level == 21 && bonus_level_unlocked == 3) {
        game.showLongText("You have finished the game and achieved the true ending, good job, even I the creator of the game struggle to achieve this even once, you are a true gamer", DialogLayout.Full)
        game.showLongText("Your final time for 100% in seconds is:", DialogLayout.Full)
        game.showLongText(game.runtime() / 1000, DialogLayout.Full)
    } else if (level == 21 && bonus_level_unlocked == 2) {
        game.showLongText("You have finished the game and and beaten 2 of the 3 bonus levels, good job, that is a great feat", DialogLayout.Full)
        game.showLongText("Your final time in seconds is:", DialogLayout.Full)
        game.showLongText(game.runtime() / 1000, DialogLayout.Full)
    } else if (level == 21 && bonus_level_unlocked == 1) {
        game.showLongText("You have finished the game and and beaten 1 of the 3 bonus levels, good job, that is hard to do", DialogLayout.Full)
        game.showLongText("Your final time in seconds is:", DialogLayout.Full)
        game.showLongText(game.runtime() / 1000, DialogLayout.Full)
    } else {
        level += 1
...
function make_coins_world3 () {
    for (let value2 of tiles.getTilesByType(assets.tile`myTile`)) {
        kingdomcoin = sprites.create(img`
            ...
            . f d d d d f . 
            . . f f f f . . 
            `, SpriteKind.world3_coin)
        tiles.placeOnTile(kingdomcoin, value2)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.world3_coin, function (sprite2, otherSprite2) {
    info.player2.changeScoreBy(1)
    otherSprite2.destroy(effects.confetti, 200)
    if (info.player2.score() == 1) {
        game.showLongText("this is a kingdom coin there are 3 hidden in each level", DialogLayout.Full)
    }
})
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (dash == 0 && controller.right.isPressed() == true) {
        dash_cooldown = 2
        dash = 1
    ...
    } else if (dash == 0 && controller.left.isPressed() == true) {
        dash_cooldown = 2
        dash = 1
        controller.moveSprite(mySprite, 300, 0)
        animation.runImageAnimation(
...
function createLevel () {
    ...
    sprites.destroyAllSpritesOfKind(SpriteKind.world2_coin)
    sprites.destroyAllSpritesOfKind(SpriteKind.Coin)
    sprites.destroyAllSpritesOfKind(SpriteKind.EnemyProjectile)
    sprites.destroyAllSpritesOfKind(SpriteKind.bossmovementtype)
    sprites.destroyAllSpritesOfKind(SpriteKind.bossmovementtypeworld2)
    sprites.destroyAllSpritesOfKind(SpriteKind.enemy_world3_left)
    sprites.destroyAllSpritesOfKind(SpriteKind.enemy_world3_right)
    sprites.destroyAllSpritesOfKind(SpriteKind.bossmovementtype3)
    boss_health_world3 = 0
    boss_health_world2 = 0
    Boss_health = 0
    for (let value of sprites.allOfKind(SpriteKind.Coin)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.world2_coin)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.world3_coin)) {
        value.destroy()
    }
    if (level == 1) {
        info.setScore(1)
        ...
        info.setScore(6)
        game.showLongText("good job getting this far, but the king has sent his strongest child to kill you, defeat her and continue your journey by leaving your home through the cave entrance", DialogLayout.Full)
        tiles.setCurrentTilemap(tilemap`Boss Fight`)
        tiles.placeOnRandomTile(mySprite, sprites.dungeon.collectibleInsignia)
        Make_boss()
    } else if (level == 7) {
        info.setScore(7)
        tiles.setCurrentTilemap(tilemap`secretlevel`)
        tiles.placeOnRandomTile(mySprite, sprites.dungeon.collectibleInsignia)
    } else if (level == 8) {
        info.setScore(8)
        ...
        scene.setBackgroundImage(img`
            ...
            `)
        info.setScore(13)
        game.showLongText("this knight blocks the way to the kings castle, defeat him and continue your quest", DialogLayout.Full)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleRedCrystal, function (sprite5, location3) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
        tiles.placeOnRandomTile(sprite5, sprites.dungeon.collectibleInsignia)
        info.changeLifeBy(-1)
        spawninvulnerability_timer = 1
    }
})
scene.onHitWall(SpriteKind.EnemyProjectile, function (sprite6, location4) {
    sprite6.destroy(effects.hearts, 100)
})
function makecoins () {
    for (let value2 of tiles.getTilesByType(assets.tile`Coinblock1`)) {
        dark_heart = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Coin)
        tiles.placeOnTile(dark_heart, value2)
        tiles.setTileAt(value2, assets.tile`transparency16`)
        animation.runImageAnimation(
        dark_heart,
        [img`
            ...
            . . f c c c c c c c b b c c f . 
            . . f c c c c c c c b b c c f . 
            . . f c c c c c c c c c c c f . 
            . . f f c c c a a a c c c f f . 
...
sprites.onOverlap(SpriteKind.bossmovementtypeworld2, SpriteKind.Player, function (sprite, otherSprite) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`fakefire`, function (sprite5, location3) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
        tiles.placeOnRandomTile(sprite5, sprites.dungeon.collectibleInsignia)
        info.changeLifeBy(-1)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.world2_coin, function (sprite2, otherSprite2) {
    info.player2.changeScoreBy(1)
    otherSprite2.destroy(effects.fire, 200)
    if (info.player2.score() == 1) {
        game.showLongText("this is a spirit heart there are 3 hidden in each level", DialogLayout.Full)
    }
})
scene.onHitWall(SpriteKind.Projectile, function (sprite4, location2) {
    sprite4.destroy(effects.ashes, 100)
})
scene.onHitWall(SpriteKind.bossmovementtype, function (sprite, location) {
    sprite.vy = 0 - sprite.vy
})
sprites.onOverlap(SpriteKind.bossmovementtype, SpriteKind.Player, function (sprite, otherSprite) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
        tiles.placeOnRandomTile(otherSprite, sprites.dungeon.collectibleInsignia)
        info.changeLifeBy(-1)
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bossmovementtypeworld2, function (sprite, otherSprite) {
    boss_health_world2 += -1
    sprite.destroy(effects.disintegrate, 100)
    if (boss_health_world2 == 0) {
        bossworld2.destroy(effects.hearts, 1000)
        if (info.player2.score() == 15) {
            game.showLongText("you have collected all spirit hearts and unlocked the bonus level", DialogLayout.Full)
            level += 1
            bonus_level_unlocked += 1
            createLevel()
        } else if (info.player2.score() < 15) {
            game.showLongText("you have beaten world 2, world 3 is harder", DialogLayout.Full)
            level += 2
            createLevel()
        }
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Coin, function (sprite2, otherSprite2) {
    ...
    otherSprite2.destroy(effects.fire, 200)
    if (info.player2.score() == 1) {
        game.showLongText("this is a dark heart there are 3 hidden in each level", DialogLayout.Full)
    }
})
function makebossworld2 () {
    bossworld2 = sprites.create(img`
        ........................
        ........................
        ........................
        ........................
        ...
        ........................
        ........................
        `, SpriteKind.bossmovementtypeworld2)
    tiles.placeOnRandomTile(bossworld2, assets.tile`myTile7`)
    boss_health_world2 = 10
    bossworld2.changeScale(1, ScaleAnchor.Middle)
    tiles.setTileAt(tiles.getTileLocation(25, 48), assets.tile`transparency16`)
    animation.runImageAnimation(
    bossworld2,
    [img`
        ..............ffffff....
...
function create_enemy () {
    for (let value of tiles.getTilesByType(assets.tile`enemy_spawn`)) {
        lightenemy = sprites.create(assets.image`enemy_bat`, SpriteKind.flyingenemy)
        tiles.placeOnTile(lightenemy, value)
    ...
    for (let value of tiles.getTilesByType(assets.tile`myTile8`)) {
        enemy_world3_left = sprites.create(img`
            ........................
            ........................
            ........................
            ........................
            ...
            ........................
            ........................
            `, SpriteKind.enemy_world3_left)
        tiles.placeOnTile(enemy_world3_left, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        animation.runImageAnimation(
        enemy_world3_left,
        [img`
    ...
    for (let value of tiles.getTilesByType(assets.tile`myTile11`)) {
        enemy_world3_right = sprites.create(img`
            ........................
            ........................
            ........................
            ........................
            ...
            ........................
            ........................
            `, SpriteKind.enemy_world3_right)
        tiles.placeOnTile(enemy_world3_right, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        animation.runImageAnimation(
        enemy_world3_right,
        [img`
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bossmovementtype, function (sprite7, otherSprite3) {
    Boss_health += -1
    sprite7.destroy(effects.disintegrate, 100)
    if (Boss_health == 0) {
        Boss.destroy(effects.hearts, 1000)
        if (info.player2.score() == 15) {
            info.player2.setScore(0)
            game.showLongText("you have collected all dark hearts and unlocked the bonus level", DialogLayout.Full)
            level += 1
            bonus_level_unlocked += 1
            createLevel()
        } else if (info.player2.score() < 15) {
            info.player2.setScore(0)
            game.showLongText("you have beaten world 1, world 2 is harder", DialogLayout.Full)
            level += 2
            createLevel()
        }
    }
})
function makecoinsworld2 () {
    for (let value2 of tiles.getTilesByType(assets.tile`myTile6`)) {
        light_heart = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . f f f f f f . f f f f f f . 
            . f f 6 6 6 6 f f f 6 6 6 6 f f 
            . f 6 6 6 6 6 6 f 6 6 6 6 6 6 f 
            . f 6 6 6 6 6 6 6 6 9 9 9 6 6 f 
            . f 6 6 6 6 6 6 6 6 9 9 9 6 6 f 
            . f 6 6 6 6 6 7 7 7 9 9 9 6 6 f 
            . f 6 6 6 6 7 7 7 7 7 6 6 6 6 f 
            . f f 6 6 7 7 7 7 7 7 7 6 6 f f 
            . . f f 6 7 7 7 7 7 7 7 6 f f . 
            ...
            . . . . . . . f f f . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.world2_coin)
        tiles.placeOnTile(light_heart, value2)
        tiles.setTileAt(value2, assets.tile`transparency16`)
        animation.runImageAnimation(
        light_heart,
        [img`
            ...
            . . . . . . . . . . . . . . . . 
            . . . f f f f f . f f f f f . . 
            . . f f 6 6 6 f f f 6 6 6 f f . 
            . . f 6 6 6 6 6 f 6 6 6 6 6 f . 
            . . f 6 6 6 6 6 6 6 9 9 6 6 f . 
            . . f 6 6 6 6 6 6 6 9 9 6 6 f . 
            . . f 6 6 6 6 6 6 6 6 6 6 6 f . 
            . . f f 6 6 6 7 7 7 6 6 6 f f . 
...
scene.onHitWall(SpriteKind.flyingenemy, function (sprite, location) {
    sprite.vy = 0 - sprite.vy
})
sprites.onOverlap(SpriteKind.flyingenemy, SpriteKind.Player, function (sprite, otherSprite) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
        tiles.placeOnRandomTile(otherSprite, sprites.dungeon.collectibleInsignia)
        info.changeLifeBy(-1)
...
function make_boss_world3 () {
    bossworld3 = sprites.create(img`
        . . . . . f f 4 4 f f . . . . . 
        . . . . f 5 4 5 5 4 5 f . . . . 
        . . . f e 4 5 5 5 5 4 e f . . . 
        ...
        . . . f f 1 d 1 d 1 d f f . . . 
        . . . . . f f b b f f . . . . . 
        `, SpriteKind.bossmovementtype3)
    tiles.placeOnRandomTile(bossworld3, assets.tile`myTile9`)
    boss_health_world3 = 10
    bossworld3.changeScale(2, ScaleAnchor.Middle)
    tiles.setTileAt(tiles.getTileLocation(31, 41), assets.tile`transparency16`)
}
function Make_boss () {
    ...
    tiles.placeOnRandomTile(Boss, assets.tile`myTile2`)
    Boss_health = 10
    Boss.changeScale(2, ScaleAnchor.Middle)
    Boss.vy = -25
}
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bossmovementtype3, function (sprite, otherSprite) {
    boss_health_world3 += -1
    sprite.destroy(effects.disintegrate, 100)
    if (boss_health_world3 == 0) {
        sprites.destroyAllSpritesOfKind(SpriteKind.enemy_world3_left, effects.hearts, 2000)
        sprites.destroyAllSpritesOfKind(SpriteKind.enemy_world3_right, effects.hearts, 2000)
        bossworld3.destroy(effects.hearts, 2000)
        if (info.player2.score() == 15) {
            game.showLongText("you have collected all kingdom coins and unlocked the bonus level", DialogLayout.Full)
            level += 1
            bonus_level_unlocked += 1
            createLevel()
        } else if (info.player2.score() < 15) {
            game.showLongText("You have beaten the game, congratulations, but if you think you're up to the challenge, go back and get all of the coins, dark hearts, and sprit hearts to unlock 3 different bonus levels", DialogLayout.Full)
            game.showLongText("Your final time for any% in seconds is:", DialogLayout.Full)
            game.showLongText(game.runtime() / 1000, DialogLayout.Full)
            game.showLongText("My best time is: 343 seconds, can you do better?", DialogLayout.Full)
        }
    }
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite8, otherSprite4) {
    controller.moveSprite(mySprite, 100, 0)
    if (spawninvulnerability_timer == 0) {
        tiles.placeOnRandomTile(sprite8, sprites.dungeon.collectibleInsignia)
        info.changeLifeBy(-1)
        spawninvulnerability_timer = 1
    }
})
let boss_projectile_world3: Sprite = null
let enemy_world3_projectile_left: Sprite = null
let enemy_world3_projectile_right: Sprite = null
let Boss_Projectile: Sprite = null
let Boss_Projectile_world2: Sprite = null
let timer2 = 0
let bossworld3: Sprite = null
let light_heart: Sprite = null
let Boss: Sprite = null
let enemy_world3_right: Sprite = null
let enemy_world3_left: Sprite = null
let lightenemy: Sprite = null
let bossworld2: Sprite = null
let double_jump = 0
let dark_heart: Sprite = null
let spawninvulnerability_timer = 0
let Boss_health = 0
let boss_health_world2 = 0
let boss_health_world3 = 0
let othertimer = 0
let levelchange = 0
let dash_cooldown = 0
let dash = 0
let kingdomcoin: Sprite = null
let projectile2: Sprite = null
let projectile: Sprite = null
let attackcooldown = 0
let attack = 0
let flying_enemy_timer = 0
let bonus_level_unlocked = 0
let level = 0
...
scene.setBackgroundImage(img`
    ...
    fffffffffcdcdffdffdccdddddd11111111111111111111111111111111111111ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddbbffffffdffffffff
    ...
    
    ...
    
    ...
    
...
info.setLife(5)
mySprite.ay += 200
game.showLongText("Controls:                 Up = shoot       Left/Right = move       B = Dash                 A = Jump                  A in air = Double Jump", DialogLayout.Full)
game.showLongText("You are a lonely ghost, living peacefully in your dungeon, but the king thinks you're evil, your quest is to set out and prove him wrong", DialogLayout.Full)
game.showLongText("When you die in a world it puts you to the beginning of that world (e.g. if you die in world 2 you reset to the start of world 2, if you die in world 1 you reset to the start of world 1), also if you die in a bonus level you go to the start of that bonus level", DialogLayout.Full)
game.onUpdate(function () {
    timer2 = 10
})
game.onUpdate(function () {
    if (mySprite.isHittingTile(CollisionDirection.Bottom) == true) {
        double_jump = 0
    }
})
game.onUpdate(function () {
    if (levelchange == 0 && othertimer == 50) {
...
game.onUpdate(function () {
    if (othertimer < 50 && levelchange == 0) {
        othertimer += 1
    }
})
game.onUpdateInterval(750, function () {
    if (boss_health_world2 > 0) {
        Boss_Projectile_world2 = sprites.createProjectileFromSprite(img`
            . . . . f f . . . 
            . . . f 1 1 f . . 
            . . f 1 1 f . . . 
            . f 1 1 f . . . . 
            ...
            . . . . f f . . . 
            `, bossworld2, -100, 0)
        Boss_Projectile_world2.setKind(SpriteKind.EnemyProjectile)
        Boss_Projectile_world2.changeScale(2, ScaleAnchor.Middle)
    }
})
game.onUpdateInterval(2000, function () {
    if (Boss_health > 0) {
        Boss_Projectile = sprites.createProjectileFromSprite(img`
            ...
            . . . f f f . . . 
            `, Boss, 50, 0)
        Boss_Projectile.setKind(SpriteKind.EnemyProjectile)
        Boss_Projectile.follow(mySprite, 50)
    }
})
game.onUpdateInterval(2000, function () {
    for (let value of sprites.allOfKind(SpriteKind.enemy_world3_right)) {
        enemy_world3_projectile_right = sprites.createProjectileFromSprite(img`
            . . . f f . . . . 
            . . f 1 1 f . . . 
            . . . f 1 1 f . . 
            . . . . f 1 1 f . 
            ...
            . . . f f . . . . 
            `, value, 100, 0)
        enemy_world3_projectile_right.changeScale(2, ScaleAnchor.Middle)
        enemy_world3_projectile_right.setKind(SpriteKind.EnemyProjectile)
    }
})
game.onUpdateInterval(2000, function () {
    for (let value of sprites.allOfKind(SpriteKind.enemy_world3_left)) {
        enemy_world3_projectile_left = sprites.createProjectileFromSprite(img`
            . . . . f f . . . 
            . . . f 1 1 f . . 
            . . f 1 1 f . . . 
            . f 1 1 f . . . . 
            ...
            . . . . f f . . . 
            `, value, -100, 0)
        enemy_world3_projectile_left.changeScale(2, ScaleAnchor.Middle)
        enemy_world3_projectile_left.setKind(SpriteKind.EnemyProjectile)
    }
})
game.onUpdateInterval(2000, function () {
    if (boss_health_world3 > 0) {
        boss_projectile_world3 = sprites.createProjectileFromSprite(img`
            . f f f . f f f . 
            f 3 3 3 f 3 3 3 f 
            f 3 3 3 3 3 1 3 f 
            f 3 3 3 3 3 3 3 f 
            ...
            . . . f f f . . . 
            `, bossworld3, 0, 100)
        boss_projectile_world3.setKind(SpriteKind.EnemyProjectile)
    }
})
game.onUpdateInterval(2000, function () {
    if (boss_health_world3 > 0) {
...
game.onUpdateInterval(1000, function () {
    for (let value of sprites.allOfKind(SpriteKind.bossmovementtype)) {
        value.vy = 0 - value.vy
    }
})
game.onUpdateInterval(500, function () {
    spawninvulnerability_timer = 0
})
